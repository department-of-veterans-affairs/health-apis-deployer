...
docker run \
       ...
       -e QA_CDW_DB_USERNAME="$QA_CDW_DB_USERNAME" \
       -e QA_CDW_DB_PASSWORD="$QA_CDW_DB_PASSWORD" \
       -e PROD_CDW_DB_USERNAME="$PROD_CDW_DB_USERNAME" \
       -e PROD_CDW_DB_PASSWORD="$PROD_CDW_DB_PASSWORD" \
       -e LAB_CDW_DB_USERNAME="$LAB_CDW_DB_USERNAME" \
       -e LAB_CDW_DB_PASSWORD="$LAB_CDW_DB_PASSWORD" \
