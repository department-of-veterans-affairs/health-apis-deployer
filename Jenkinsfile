...
pipeline {
  ...
  parameters {
    ...
    choice(name: 'PRODUCT', choices: ['none','bulk-fhir','carma','carma-fms-connector','claims','community-care','data-query','dmc-vet-search','email-to-case','exemplar','gal','gal-processor','hotline','logging','mock-ee', 'mock-vler','monitoring','provider-directory','squares','urgent-care'], description: "Install this product")
