...
pipeline {
  ...
  parameters {
    ...
    choice(name: 'PRODUCT', choices: ['none','carma','carma-fms-connector','community-care','data-query','exemplar','gal','gal-processor','hotline','logging','mock-ee','monitoring','provider-directory','squares','urgent-care'], description: "Install this product")
