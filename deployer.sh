...
Powedering noses ...
Fluffing pillows ...
Submitting TPS report ...
Computing prime numbers ...
Aligning stars ...
Seeding random number generator ...
Ramming rams in to ram ...
...
Tying shoes ...
Ordering pizza ...
Retracing Lewis and Clark's steps ...
Putting a watermelon inside a watermelon!
... napping ...
...
waitForPodsToBeRunning() {
  ...
  sleep 20s
  (IFS=$'\n'; for l in $(echo "$THINGS_TO_SAY" | sort -R | head -10); do  echo "  $l"; sleep 10 ; done)
  local running=false
